...
export const programmes: Programme[] = [
  {
    ...
    tagline: "A curated immersion — direct access to Swiss businesses, networks, and operating culture.",
    oneLineFor: "International decision-makers entering, expanding, or partnering in Switzerland.",
    outcome: "Direct introductions, an operating-culture briefing, and an alumni network you can call on.",
    href: "/programmes/access",
    city: "Zurich",
    durationLabel: "5 days · in residence",
    whoFor:
      "Senior international executives, founders, and family-office principals considering Swiss expansion, partnerships, or capital relationships.",
    notFor:
      "Open enrolment for early-career professionals, generic networking participants, or those seeking 1:1 advisory.",
    fee: "CHF 14,500",
    feeIncludes: [
      "Five days in residence with cohort of twelve",
      "Curated host introductions and small-group sessions",
      "Materials, briefings, and post-cohort access",
      "Welcome dinner and two structured cohort meals",
    ],
    ...
    architecture: [
      {
        phase: "Phase 01",
        title: "Pre-immersion",
        body: "A two-week structured preparation: reading, framing calls with hosts, and a written briefing on your specific access objectives.",
      },
      {
        phase: "Phase 02",
        title: "Days in residence",
        body: "Five working days in Zurich. Mornings with hosts and faculty; afternoons in small-group rooms with named Swiss principals; evenings reserved for considered cohort dialogue.",
      },
      {
        phase: "Phase 03",
        title: "Follow-on access",
        body: "Twelve months of curated alumni access — quarterly host dispatches, named introductions on request, and an annual alumni day in Zurich.",
      },
    ],
    format: [
      { label: "Location", value: "Zurich, in residence" },
      { label: "Languages", value: "English (DE / FR on request)" },
      { label: "Group size", value: "Twelve in the room" },
      { label: "Schedule", value: "Five consecutive days · 09:00 – 18:00" },
      { label: "Materials", value: "Briefings, host notes, alumni handbook" },
      { label: "Alumni access", value: "Twelve months follow-on" },
    ],
    faqs: [
      {
        q: "Is this advisory or coaching?",
        a: "No. Vision Goal is a curated access platform. Hosts and faculty appear as practitioners, not advisors. We do not deliver coaching, consulting, or any regulated financial service.",
      },
      {
        q: "Will participants be named publicly?",
        a: "Discretion is the default. Cohort composition is shared with participants only. Public attribution requires written consent.",
      },
      {
        q: "What is the application review like?",
        a: "Applications are reviewed by the host curation team. We assess fit, specificity of access objectives, and the calibre of your contribution to the room. Expected response within ten business days.",
      },
      {
        q: "Refund and deferral policy?",
        a: "A single deferral to the next cohort is available up to thirty days before start. Refunds beyond the cooling-off window are not standard — see the application terms.",
      },
    ],
    outcomes: [
      "An operating-culture map of Swiss SME and partner expectations — the signals that read inside the room and the ones that don’t.",
      "Three to five named introductions selected against your written access objectives, mediated by the host curation team.",
      "Twelve months of follow-on alumni access — quarterly host dispatches, an annual Zurich reconvening, and named introductions on request.",
    ],
  },
  {
    id: "banking",
    ...
    oneLineFor: "Senior professionals adjacent to Swiss private banking who need practitioner-grade insight.",
    outcome: "Chatham-house dialogue with practitioners, a clear map of the landscape, and considered judgement.",
    href: "/programmes/banking",
    city: "Geneva",
    durationLabel: "4 days · chatham-house",
    whoFor:
      "Senior professionals in finance, wealth, family office, or advisory adjacent to Swiss private banking. Practitioner-grade audience only.",
    notFor:
      "Retail investors, sales professionals seeking leads, or media. The room is closed; nothing said is for attribution.",
    fee: "CHF 12,800",
    feeIncludes: [
      "Four-day intensive under chatham-house rules",
      "Sessions with named practitioners and former principals",
      "Curated reading and briefing materials",
      "Two cohort dinners in Geneva",
    ],
    feeExcludes: ["Travel", "Accommodation", "Personal expenses"],
    architecture: [
      {
        phase: "Phase 01",
        title: "Pre-reading",
        body: "Curated briefings on the Swiss private banking landscape, regulation, and current practitioner debates — circulated two weeks ahead.",
      },
      {
        phase: "Phase 02",
        title: "Days in Geneva",
        body: "Four days of closed sessions. Mornings on landscape and structure; afternoons on practitioner judgement; evenings reserved for dialogue. Nothing recorded; nothing for attribution.",
      },
      {
        phase: "Phase 03",
        title: "Continued dialogue",
        body: "An invitation-only continued-dialogue list — quarterly practitioner notes and an annual reconvening for cohort alumni.",
      },
    ],
    format: [
      { label: "Location", value: "Geneva, chatham-house venue" },
      { label: "Languages", value: "English" },
      { label: "Group size", value: "Twelve in the room" },
      { label: "Schedule", value: "Four consecutive days · 09:30 – 17:30" },
    ...
    faqs: [
      {
        ...
        a: "No. The intensive is educational and curatorial. Practitioners speak as practitioners; the platform does not provide regulated financial, tax, or legal advice.",
      },
      {
      ...
      },
      {
        ...
        a: "Practitioners are named on the cohort page and present in their personal capacity. Institutional introductions are not the product; practitioner judgement is.",
      },
      {
    ...
    outcomes: [
      "A practitioner-grade map of the Swiss private banking landscape — structures, postures, and the working questions held in the closed room.",
      "Direct chatham-house dialogue with named former principals and current practitioners on the questions that shape your remit.",
      "Continued access — quarterly practitioner notes, an annual reconvening, and a small register of cohort alumni you can call on.",
    ],
  },
  {
    id: "topic",
    ...
    tagline: "A themed week of curated rooms — one Swiss finance topic, hosted by practitioners.",
    oneLineFor: "Senior professionals and institutional partners going deep on one current question.",
    outcome: "A structured week of curated rooms, host commentary, and follow-on access on the topic.",
    href: "/programmes/topic",
    city: "Zurich",
    durationLabel: "5 days · curated",
    whoFor:
      "Senior professionals, institutional partners, and policy practitioners with a working stake in the announced topic. Posture is contributory, not observational.",
    notFor:
      "Press, junior staff seeking exposure, or vendors prospecting for business. The week is curated for working contributors, not audience.",
    fee: "CHF 9,500",
    feeIncludes: [
      "Five themed days in Zurich",
      "Curated rooms hosted by named practitioners",
      "Topic dossier and post-week host dispatch",
      "Welcome reception and topic dinner",
    ],
    feeExcludes: ["Travel", "Accommodation", "Personal expenses"],
    architecture: [
      {
        phase: "Phase 01",
        title: "Topic dossier",
        body: "A structured topic dossier circulated three weeks ahead — framings, primary sources, and the questions the week intends to address.",
      },
      {
        phase: "Phase 02",
        title: "Curated week",
        body: "Five days of curated rooms. Each room is built around a specific question with a host who has working judgement on it. The week ends with a synthesis session.",
      },
      {
        phase: "Phase 03",
        title: "Follow-on dispatch",
        body: "A post-week host dispatch summarising the synthesis, plus continued-dialogue access for six months on the topic.",
      },
    ],
    format: [
      { label: "Location", value: "Zurich, curated venues" },
      { label: "Languages", value: "English" },
      { label: "Group size", value: "Twenty-four maximum, divided into rooms of twelve" },
      { label: "Schedule", value: "Five consecutive days · 09:00 – 18:00" },
      { label: "Materials", value: "Topic dossier, room notes, post-week dispatch" },
      { label: "Follow-on access", value: "Six months on the topic" },
    ],
    faqs: [
      {
        q: "How is the topic selected?",
        a: "The host curation team selects one current Swiss finance question per year, surfaced from practitioner conversations and reader dispatches.",
      },
      {
      ...
      {
        q: "Can I attend a single day?",
        a: "No. The week is a single curated arc; rooms reference and build on each other. Single-day attendance dilutes the room for everyone.",
      },
      {
    ...
    outcomes: [
      "A working synthesis of the year's chosen Swiss finance question — drawn from rooms designed for contributors with operational stake.",
      "A post-week host dispatch — circulated to cohort alumni only — capturing the decisions, divergences, and follow-on questions.",
      "Six months of continued-dialogue access on the topic — practitioner correspondence, named follow-on introductions where useful.",
    ],
  },
];
